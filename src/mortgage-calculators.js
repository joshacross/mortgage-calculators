!(function () {
  ...
  (window.mortgageCalculators = {}),
    (window.mortgageCalculators.monthlyMortgagePayments = function (t) {
      var o = e(t, {
        loanAmount: {
          isRequired: !0,
          isNumber: !0,
      ...
      return o.error ? { error: o.error } : i(r(t));
    }),
    (window.mortgageCalculators.monthlyMortgagePaymentsWithExtraPayments =
      function (o) {
        var a = e(o, {
          loanAmount: {
            isRequired: !0,
        ...
        for (
          var s = o.interestRate / 100 / 12,
            n = 12 * o.termInYears,
            N = o.extraPaymentAmount,
            m = r({
        ...
        for (var b = [], f = 0; f <= Math.ceil(d.length); f += 12)
          b.push(d.slice(f, f + 12));
        for (var h = [], I = o.loanAmount, F = 0; F < b.length; F++) {
          for (var P = 0, p = 0, q = 0; q < b[F].length; q++)
            (P += b[F][q].interestPayment), (p += b[F][q].principalPayment);
          I - p >= 0 ? I >= p && (I -= p) : (I -= p = I),
            h.push({
    ...
    (window.mortgageCalculators.compareFifteenVsThirtyYearMortgages = function (
      t
    ) {
      var o = e(t, {
        loanAmount: {
      ...
      var a = t.loanAmount,
        s = t.interestRate1,
        n = t.interestRate2,
        N = r({ loanAmount: a, interestRate: s, termInYears: 15 }),
        m = r({ loanAmount: a, interestRate: n, termInYears: 30 });
      return {
        fifteenYearMortgage: {
    ...
    (window.mortgageCalculators.refinanceMortgage = function (o) {
      ...
      for (
        var s = o.loanAmount,
          ...
          u = o.newTermInYears,
          l = o.paymentsMade,
          g = r({ loanAmount: s, interestRate: n, termInYears: N }),
          R = s,
          y = 0,
          d = 0;
        d < l;
      ...
      var b = g * N * 12 - s - y,
        f = R,
        h = r({ loanAmount: f, interestRate: m, termInYears: u }),
        I = h * u * 12 - R;
      return {
        interestSaved: i(b - I),
        oldMonthlyMortgage: {
    ...
    (window.mortgageCalculators.comparefixedRateVsARM = function (o) {
      ...
      if (a.error) return { error: a.error };
      for (
        var s = o.interestRate,
          n = o.termInYears,
          N = o.loanAmount,
          m = o.initialInterestRate,
          u = o.expectedAdjustmentRate,
          l = o.monthsBeforeFirstAdjustment,
          g = o.monthsBetweenAdjustments,
          R = o.maximumInterestRate,
          y = r({ loanAmount: N, interestRate: s, termInYears: n }),
          d = r({ loanAmount: N, interestRate: m, termInYears: n }),
          v = N,
          c = 0;
        c < l;
        c++
      ...
      for (
        var b = m + u,
          f = r({ loanAmount: v, interestRate: b, termInYears: n - l / 12 }),
          h = 0;
        h < g;
        h++
      ) {
      ...
      return (
        (response = {
          fixedRate: { monthlyMortgagePayment: i(y) },
          ARM: {
    ...
    (window.mortgageCalculators.compareBuyVsRent = function (o) {
      ...
      for (
        var s = o.monthlyRent,
          n = o.expectedAnnualRentIncrease,
          N = o.purchasePrice,
          m = (o.downPayment / 100) * N,
          u = N - m,
          l = o.interestRate,
          g = o.termInYears,
          R = (o.closingCosts / 100) * u,
          y = o.howLongBeforeSelling,
          d = o.incomeTaxRate,
          v = o.annualAppreciation,
          c = r({ loanAmount: u, interestRate: l, termInYears: g }),
          b = 0,
          f = 0,
          h = 0,
          I = N,
